...
export const getLayoutState = (state: AppState) => {console.log("------");console.log(state); return state.layout;}
...
export const getGamesState = (state: AppState) => {console.log(state);return state.games};
